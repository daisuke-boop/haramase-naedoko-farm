...
export type AnimZone = { id: string, x: number, y: number, w: number, h: number, spriteW?: number, spriteH?: number, type: AnimZoneType, map?: string, timeOfDay?: TimeOfDay, timeOfDays?: TimeOfDay[] };
