...
export const HERO_SKILL_DATA: readonly HeroSkillData[] = [
  ...
  { id: 'gather_fishing_rare_up', name: '探索の勘I', category: 'gather', costSP: 2, description: '釣りのレア率を増加する。', effectType: 'fishingRarePercent', effectValue: 5, maxRank: 1, requiredHeroLevel: 1, requiredSkillIds: [], isHidden: false, treeParentIds: [], treeColumn: 0, treeRow: 1, icon: '🎣' },
  { id: 'gather_mining_rare_up', name: '探索の勘II', category: 'gather', costSP: 2, description: '採掘のレア率を増加する。', effectType: 'miningRarePercent', effectValue: 5, maxRank: 1, requiredHeroLevel: 1, requiredSkillIds: [], isHidden: false, treeParentIds: ['gather_fishing_rare_up'], treeColumn: 1, treeRow: 2, icon: '⛏' },
  { id: 'gather_lumber_rare_up', name: '採集の目利き', category: 'gather', costSP: 2, description: '伐採のレア率を増加する。', effectType: 'lumberRarePercent', effectValue: 5, maxRank: 1, requiredHeroLevel: 1, requiredSkillIds: [], isHidden: false, treeParentIds: ['gather_mining_rare_up'], treeColumn: 2, treeRow: 3, icon: '🪓' },
