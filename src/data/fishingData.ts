...
export const FISHING_FISH_DATA: readonly FishingFishData[] = [
  ...
  { id: 'aoningyo', no: 22, name: '青い人魚', imageSrc: '/img/22aoningyo.jpg', minSize: 165, maxSize: 165, minPrice: 1000000, maxPrice: 1000000, bossPrice: 5000000, unlockDifficulty: 'hard', sellable: true, rarity: 'legendary', fixedSize: 165, note: 'HARD限定・ファンタジー枠' },
  { id: 'kiironingyo', no: 23, name: '黄色い人魚', imageSrc: '/img/23kiironingyo.jpg', minSize: 145, maxSize: 145, minPrice: 500000, maxPrice: 500000, bossPrice: 2500000, unlockDifficulty: 'hard', sellable: true, rarity: 'legendary', fixedSize: 145, note: 'HARD限定・ファンタジー枠' },
  { id: 'pinkningyo', no: 24, name: 'ピンクの人魚', imageSrc: '/img/24pinkningyo.jpg', minSize: 162, maxSize: 162, minPrice: 750000, maxPrice: 750000, bossPrice: 3750000, unlockDifficulty: 'hard', sellable: true, rarity: 'legendary', fixedSize: 162, note: 'HARD限定・ファンタジー枠' },
] as const;
